                                    ...
                                    <React.Fragment key={t.id}>
                                        <tr className="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="p-4 text-right">
                                                <span className={`text-xs font-bold px-2 py-1 rounded uppercase tracking-wide ${t.status === 'completed' ? 'bg-green-50 text-green-600' :
                                                    t.status === 'pending' ? 'bg-amber-50 text-amber-600' : 'bg-gray-50 text-gray-500'
                                                    }`}>
                                                    {t.status}
                                                </span>
                                            </td>
